...
namespace LaughingDogStudios.Salvage.Logic.Models.Base
    ...
    /// 
    /// </summary>
    [TypeConverter(typeof(TypeConverterGeneric<TSDynamic_Base>))]
    public partial class TSDynamic_Base: SceneObject
{
...
#region ProxyObjects Operator Overrides
        ...
        /// <returns></returns>
        public static bool operator ==(TSDynamic_Base ts, string simobjectid)
            {
  ...
  /// <summary>
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator string( TSDynamic_Base ts)
            {
            if (object.ReferenceEquals(ts, null))
                 return "0";
            return ts._ID;
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator TSDynamic_Base(string ts)
            {
            uint simobjectid = resolveobject(ts);
           return  (TSDynamic_Base) Omni.self.getSimObject(simobjectid,typeof(TSDynamic_Base));
            }
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator int( TSDynamic_Base ts)
            {
            return (int)ts._iID;
            }
        ...
        /// <param name="simobjectid"></param>
        /// <returns></returns>
        public static implicit operator TSDynamic_Base(int simobjectid)
            {
            return  (TSDynamic) Omni.self.getSimObject((uint)simobjectid,typeof(TSDynamic_Base));
            }
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator uint( TSDynamic_Base ts)
            {
            return ts._iID;
            }
        ...
        /// </summary>
        /// <returns></returns>
        public static implicit operator TSDynamic_Base(uint simobjectid)
            {
            return  (TSDynamic_Base) Omni.self.getSimObject(simobjectid,typeof(TSDynamic_Base));
            }
#endregion
...
/// <summary>
/// Enables detailed culling of meshes within the TSDynamic. Should only be used      with large complex shapes like buildings which contain many submeshes. 
/// </summary>
...
pInvokes.m_ts.fnTSDynamic_changeMaterial(_ID, mapTo, oldMat, newMat);
}
/// <summary>
...
return pInvokes.m_ts.fnTSDynamic_getModelFile(_ID);
}
/// <summary>
...
return pInvokes.m_ts.fnTSDynamic_getTargetCount(_ID);
}
/// <summary>
...
return pInvokes.m_ts.fnTSDynamic_getTargetName(_ID, index);
}
