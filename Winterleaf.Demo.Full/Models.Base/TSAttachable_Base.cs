...
namespace LaughingDogStudios.Salvage.Logic.Models.Base
    ...
    /// 
    /// </summary>
    [TypeConverter(typeof(TypeConverterGeneric<TSAttachable_Base>))]
    public partial class TSAttachable_Base: TSPathShape
{
...
#region ProxyObjects Operator Overrides
        ...
        /// <returns></returns>
        public static bool operator ==(TSAttachable_Base ts, string simobjectid)
            {
  ...
  /// <summary>
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator string( TSAttachable_Base ts)
            {
            if (object.ReferenceEquals(ts, null))
                 return "0";
            return ts._ID;
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator TSAttachable_Base(string ts)
            {
            uint simobjectid = resolveobject(ts);
           return  (TSAttachable_Base) Omni.self.getSimObject(simobjectid,typeof(TSAttachable_Base));
            }
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator int( TSAttachable_Base ts)
            {
            return (int)ts._iID;
            }
        ...
        /// <param name="simobjectid"></param>
        /// <returns></returns>
        public static implicit operator TSAttachable_Base(int simobjectid)
            {
            return  (TSAttachable) Omni.self.getSimObject((uint)simobjectid,typeof(TSAttachable_Base));
            }
        ...
        /// <param name="ts"></param>
        /// <returns></returns>
        public static implicit operator uint( TSAttachable_Base ts)
            {
            return ts._iID;
            }
        ...
        /// </summary>
        /// <returns></returns>
        public static implicit operator TSAttachable_Base(uint simobjectid)
            {
            return  (TSAttachable_Base) Omni.self.getSimObject(simobjectid,typeof(TSAttachable_Base));
            }
#endregion
...
return pInvokes.m_ts.fnTSAttachable_attachObject(_ID, obj);
}
/// <summary>
...
pInvokes.m_ts.fnTSAttachable_detachAll(_ID);
}
/// <summary>
...
return pInvokes.m_ts.fnTSAttachable_detachObject(_ID, obj);
}
/// <summary>
...
return pInvokes.m_ts.fnTSAttachable_getAttachment(_ID, index);
}
/// <summary>
...
return pInvokes.m_ts.fnTSAttachable_getNumAttachments(_ID);
}
